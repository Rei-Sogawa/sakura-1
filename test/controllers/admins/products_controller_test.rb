...
class Admins::ProductsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should show admins_product" do
    get admins_product_url(@admins_product)
    assert_response :success
  end

  test "should get edit" do
    get edit_admins_product_url(@admins_product)
    assert_response :success
  end

  test "should update admins_product" do
    patch admins_product_url(@admins_product), params: { admins_product: {  } }
    assert_redirected_to admins_product_url(@admins_product)
  end

  test "should destroy admins_product" do
    assert_difference('Admins::Product.count', -1) do
      delete admins_product_url(@admins_product)
    end
